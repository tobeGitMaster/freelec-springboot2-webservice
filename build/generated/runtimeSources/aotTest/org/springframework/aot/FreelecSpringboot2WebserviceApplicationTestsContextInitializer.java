...
/**
 * AOT generated context for {@code FreelecSpringboot2WebserviceApplicationTests}.
 */
public class FreelecSpringboot2WebserviceApplicationTestsContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext context) {
    ...
    org.springframework.boot.autoconfigure.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerAutoConfigurationPackages_BasePackages(beanFactory);
    ...
    org.springframework.boot.autoconfigure.websocket.servlet.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerWebSocketServletAutoConfiguration_TomcatWebSocketConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.websocket.servlet.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerTomcatWebSocketConfiguration_websocketServletWebServerCustomizer(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerServletWebServerFactoryConfiguration_EmbeddedTomcat(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerEmbeddedTomcat_tomcatServletWebServerFactory(beanFactory);
    ...
    org.springframework.boot.context.properties.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerConfigurationPropertiesBinder_Factory(beanFactory);
    org.springframework.boot.context.properties.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerConfigurationPropertiesBinder(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerDispatcherServletAutoConfiguration_DispatcherServletConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerDispatcherServletConfiguration_dispatcherServlet(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerDispatcherServletAutoConfiguration_DispatcherServletRegistrationConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerDispatcherServletRegistrationConfiguration_dispatcherServletRegistration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.error.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_WhitelabelErrorViewConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerWhitelabelErrorViewConfiguration_error(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerWhitelabelErrorViewConfiguration_beanNameViewResolver(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_DefaultErrorViewResolverConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerDefaultErrorViewResolverConfiguration_conventionErrorViewResolver(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.error.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_errorPageCustomizer(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_preserveErrorControllerTargetClassPostProcessor(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerWebMvcAutoConfiguration_EnableWebMvcConfiguration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerEnableWebMvcConfiguration_welcomePageHandlerMapping(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerWebMvcAutoConfiguration_WebMvcAutoConfigurationAdapter(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jackson.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerJacksonAutoConfiguration_Jackson2ObjectMapperBuilderCustomizerConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerJackson2ObjectMapperBuilderCustomizerConfiguration_standardJacksonObjectMapperBuilderCustomizer(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jackson.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerJacksonAutoConfiguration_JacksonObjectMapperBuilderConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerJacksonObjectMapperBuilderConfiguration_jacksonObjectMapperBuilder(beanFactory);
    org.springframework.boot.autoconfigure.jackson.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerJacksonAutoConfiguration_ParameterNamesModuleConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerParameterNamesModuleConfiguration_parameterNamesModule(beanFactory);
    org.springframework.boot.autoconfigure.jackson.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerJacksonAutoConfiguration_JacksonObjectMapperConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerJacksonObjectMapperConfiguration_jacksonObjectMapper(beanFactory);
    ...
    org.springframework.boot.autoconfigure.http.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerHttpMessageConvertersAutoConfiguration_StringHttpMessageConverterConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.http.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerStringHttpMessageConverterConfiguration_stringHttpMessageConverter(beanFactory);
    org.springframework.boot.autoconfigure.http.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerJacksonHttpMessageConvertersConfiguration_MappingJackson2HttpMessageConverterConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.http.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerMappingJackson2HttpMessageConverterConfiguration_mappingJackson2HttpMessageConverter(beanFactory);
    org.springframework.boot.autoconfigure.http.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerJacksonHttpMessageConvertersConfiguration(beanFactory);
    ...
    org.springframework.boot.sql.init.dependency.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerDatabaseInitializationDependencyConfigurer_DependsOnDatabaseInitializationPostProcessor(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.FreelecSpringboot2WebserviceApplicationTestsContextInitializer.registerHttpEncodingAutoConfiguration_localeCharsetMappingsCustomizer(beanFactory);
